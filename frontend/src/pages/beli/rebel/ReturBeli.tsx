...
// import BeliPrintKomponent from '../printcoba/BeliPrintKomponent'
...
const ReturBeli: React.FC = (kledo: any) => {
  ...
  }, [AmbilData, getBeliDetail, getPembelianDetail, form])
  ...
  const { mutate: simpanRetur } = useAddReturBeliMutation()
              ...
              >
                <div className="my-select-container">
                  ...
                  <Select
                    ...
                    defaultValue={
                      AmbilData && getBeliDetail && getBeliDetail.length > 0
                        ? getBeliDetail[0]?.id_outlet
                        : undefined
                    }
                  >
                    {user && user.isAdmin ? (
                      outletData?.map((Itsonyou) => (
                      ...
                      <Select.Option
                        key={user && user.id_outlet}
                        value={user && user.id_outlet}
                      >
                        {outletData &&
                          outletData.find(
                            (outlet) => outlet._id === user?.id_outlet
                          )?.nama_outlet}
                      </Select.Option>
                    )}
