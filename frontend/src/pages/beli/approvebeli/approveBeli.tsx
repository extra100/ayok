...
import { useAddApproveBeliMutation } from '../../../hooks/approveBeliHooks'
import UserContext from '../../../contexts/UserContext'
import { useGetStoksQuery } from '../../../hooks/stokHooks'

const ApproveBeli: React.FC = (kledo: any) => {
  ...
  const { mutate: simpanRetur } = useAddApproveBeliMutation()
